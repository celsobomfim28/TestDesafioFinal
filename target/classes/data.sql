...
VALUES (1, '11637346085', STR_TO_DATE('17/12/1999', '%d/%m/%Y'), 'charles@email.com', 'Charles Coabra', '11943929756', '1');
INSERT INTO tb_clientes (id_cliente, cpf, data_nascimento, email, nome, telefone, id_endereco) 
VALUES (2, '55721837098', STR_TO_DATE('11/02/1995', '%d/%m/%Y'), 'ana@email.com', 'Ana Cristina', '11994398497', '2');
...
VALUES (1, STR_TO_DATE('11/03/2021', '%d/%m/%Y'), '1234567890', '20000.0', 'SALARIO', 'ATIVADO', 1, 1);
INSERT INTO tb_contas (id_conta, data_abertura, numero_da_conta, saldo, tipo_conta, status_conta, id_agencia, id_cliente) 
VALUES (2, STR_TO_DATE('14/04/2021', '%d/%m/%Y'), '0987654321', '10000.0', 'SALARIO', 'DESATIVADO', 1, 2);

INSERT INTO tb_movimentacoes (id_movimentacao, data_movimentacao, tipo, valor_transacao, id_conta_destino, id_conta_origem) 
VALUES (1, STR_TO_DATE('11/09/2021', '%d/%m/%Y'), 'TRANSFERENCIA', '5000.0', 1, 2);
